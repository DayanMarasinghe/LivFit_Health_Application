...
public class LunchUpdate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lunch_update);

        button = (Button)findViewById(R.id.lupdate);
        textView1 = (TextView)findViewById(R.id.lname);
        textView2 = (TextView)findViewById(R.id.lcal);
        editText = (EditText)findViewById(R.id.lqty);
